...
const hints5 = [
  { label: 'Mission 5', content: 'A、B、C、D、E、F六個人圍著圓桌坐下' },
  { label: 'Mission 5', content: 'B 是坐在 A 右邊的第二人' },
  { label: 'Mission 5', content: 'E 和 F 兩人不相鄰' },
  { label: 'Mission 5', content: 'E 坐在 D 的正對面' },
  { label: 'Mission 5', content: 'F 是坐 C 在左邊的第二人' },
  { label: 'Mission 5', content: '從A開始順時鐘算起，他們六個人是怎麼坐的呢？' },
] // A C D F B E
