const hints = [
  { label: 'mission 1', content: 'tempor esse exercitation' },
  { label: 'mission 1', content: 'sint consequat dolor' },
  { label: 'mission 1', content: 'consequat laboris sint' },
  { label: 'mission 1', content: 'anim ipsum aliquip' },
]
